...
```{r}
## Logistic Regression
table(resultcheck > .5, validation_data$churn)
...
##Improvised Model
table(resultcheck2 > 0.5, validation_data$churn)
...
The Decision Tree did a better job of predicting those who would churn (Sensitivity: 98%) and the Improvised Logistic Model had a sensitivity of 97%. Decision tree predicted 45 more people who churned than the improvised logistic model. 
