...
ggcorrplot(cc, method = "circle", type = "lower", ggtheme = ggplot2::theme_classic)
```
...
```{r}
# A test IIA hypothesis (independence of irrelevant alternatives) for a multinomial logit model. Basically the lower the better.
